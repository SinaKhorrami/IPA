...
/**
 * Created by Shahin on 1/27/16 AD.
 */
public class FlyOutContainer extends LinearLayout {
    ...
    protected static final int menuMArgin = 250;
    ...
    //Animation objects
    protected Scroller menuAnimationScroller = new Scroller(this.getContext(), new SmoothInterpoletor());
    protected Runnable menuAnimationRunnable = new AnimationRunnable();
    protected android.os.Handler menuAnimationHandler = new android.os.Handler() ;
    ...
    protected class SmoothInterpoletor implements Interpolator {
    ...
    protected class AnimationRunnable implements Runnable {
        ...
        @Override
        public void run() {
            boolean isAnimationOmgoing = FlyOutContainer.this.menuAnimationScroller.computeScrollOffset();

            FlyOutContainer.this.adjustContentPosition(isAnimationOmgoing);
        }
    }
